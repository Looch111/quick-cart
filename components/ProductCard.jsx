    ...
    return (
        ...
        >
            ...
            <div className="flex items-end justify-between w-full mt-1">
                ...
                <div className="flex items-center gap-2">
                    <button onClick={handleAddToCartClick} className="w-6 h-6 flex items-center justify-center rounded-full text-gray-500 text-lg font-bold border border-gray-500/20">
                        +
                    </button>
