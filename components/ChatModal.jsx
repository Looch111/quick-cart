                ...
                {messages.map(msg => (
                    <div key={msg.id} className={`flex items-end gap-2 ${msg.senderId === userData?._id ? 'justify-end' : 'justify-start'}`}>
                        ...
                        <div className="flex flex-col">
                            <p className="text-xs text-gray-500 ml-3 mb-1">{msg.senderName}</p>
...
const AdminConversationList = ({ conversations, conversationsLoading, activeConversationId, setActiveConversationId }) => (
            ...
            <div className="bg-white rounded-lg shadow-2xl w-full max-w-4xl h-[85vh] md:h-[70vh] flex flex-col relative">
                <div className="p-4 border-b flex justify-between items-center flex-shrink-0">
                     <div className="flex items-center gap-3">
                        ...
                        {!isAdmin && <Users className="w-6 h-6 text-orange-600" />}
